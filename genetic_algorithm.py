...
class GA:
	...
	#   
        ...
        while(len(copy_individuals)> k//2):
            random_tournsize_individuals = [copy_individuals[random.randint(1,len(copy_individuals))] for i in range(tournsize)]
            fittest_individual = max(random_tournsize_individuals)
            chosen.append(fittest_individual)
            for i in random_tournsize_individuals:
                copy_individuals.remove(i)
        return chosen
	...
	#  
	#   
        n_points = [random.randint(1, len(ind1.solution)) for i in range(1, random.randint(1, len(ind1.solution))) if i not in n_points]
